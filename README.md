...
- `GET /book-appointment`: Accepts URL query parameters `start`, `end`, `tz` (timezone offset), `type`, and `visa_type`. Logs the localized time to Supabase and issues a 302 redirect to the Google Calendar `TEMPLATE` action URL.
